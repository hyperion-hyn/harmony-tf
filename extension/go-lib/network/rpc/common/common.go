...
import (
	"github.com/hyperion-hyn/hyperion-tf/extension/go-lib/network/rpc/sharding"
	...
	goSDK_Sharding "github.com/hyperion-hyn/hyperion-tf/extension/go-sdk/pkg/sharding"
)
